...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.org.blog.myblog.common.annotation.LogAnnotation)")
...
//        log.setParams(params);
        ...
        User user = userService.findSaltByAccount(account);
