package com.org.blog.myblog.common.controlleradvice;

import com.org.blog.myblog.common.constant.ResultCode;
import com.org.blog.myblog.common.result.ParameterInvalidItem;
...
public class GlobalExceptionHandler {
    ...
    public Result handleMethodArgumentNotValidException(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        return ResultApiHandler.BuildApiResult(paramIsInvalid.code(),paramIsInvalid.message(), parameterInvalidItemList);
    }
