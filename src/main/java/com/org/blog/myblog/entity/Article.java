...
public class Article extends BaseEntity<Integer> {
    ...
    private List<ArticleAvatar> articleAvatars;
    ...
    public List<ArticleAvatar> getArticleAvatars() {
        return articleAvatars;
    }

    public void setArticleAvatars(List<ArticleAvatar> articleAvatars) {
        this.articleAvatars = articleAvatars;
    }
